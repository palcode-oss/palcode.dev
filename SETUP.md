...
- `PAL_CPU_QUOTA` - the maximum amount of CPU cores the container can use, in units of 10^-9 cores. Again, this is not a reservation. This [Python Pi calculator](https://gist.github.com/palkerecsenyi/ec4642f28c7cba9f2dac613b62a6adb2) is useful for testing this (try >10000 digits). *Default: 80000000* (0.08 cores)
